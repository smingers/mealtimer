...
$(document).ready(function () {
    ...
    var buildRecipe = function (recipe) {
        ...
        for (var i = 0, length = recipe.steps.length; i < length; i++) {
            ...
            $('.steps').append('<div class="panel panel-default" data-time="' + recipe.steps[i].time +'" data-passive="' + passive + '" id="' + stepNum + '"><div class="panel-heading"><div class="progress-bar step-progress" role="progressbar"></div><div class="step-controls"><div class="btn-group step-btn"><button type="button" class="btn btn-default btn-xs play disabled"><span class="glyphicon glyphicon-play"></span></button><button type="button" class="btn btn-default btn-xs more" data-container="body" data-toggle="popover"><span class="glyphicon glyphicon-chevron-down"></span></button></div><span class="step-times"><span class="elapsed small"></span><span class="divisor small"></span><span class="total small">' + stepTime + '</span></span></div></div><table class="table"><tr><tbody><td class="step-ordinal">' + stepNum + '</td><td class="step-text">'+ stepText +'</td></tbody></tr></table></div>');
