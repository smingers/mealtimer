  ...
  Tour = (function() {
    function Tour(options) {
      this._options = $.extend({
        ...
        duration: false,
        basePath: "",
        template: "<div class='popover'> <div class='arrow'></div> <h3 class='popover-title'></h3> <div class='popover-content'></div> <div class='popover-navigation'> <div class='btn-group'> <button class='btn btn-sm btn-link' data-role='prev'>&laquo; Prev</button> <button class='btn btn-sm btn-link' data-role='next'>Next &raquo;</button> <button class='btn btn-sm btn-link' data-role='pause-resume' data-pause-text='Pause' data-resume-text='Resume'>Pause</button> </div> <button class='btn btn-sm btn-link' data-role='end'>End tour</button> </div> </div>",
